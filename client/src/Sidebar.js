...
function Sidebar() {
  return (
    <div className='sticky flex flex-col flex-grow-1 flex-shrink-1 basis-[20%] rounded-lg text-center h-fit'>
        <div className="flex flex-col object-contain items-center border-[1px] border-gray-300 border-b-0 rounded-t-lg bg-white pb-4">
            <img className='rounded-t-lg' src="https://media.licdn.com/dms/image/D4D16AQHfzYQ4t-da2Q/profile-displaybackgroundimage-shrink_350_1400/0/1701505188371?e=1707955200&v=beta&t=3vZ8ONkR9VJIUTnFPXJMB2vPO9avbrqmCNDsBRBwFqQ" alt="" />
            <Avatar className='-mt-9 mb-4 border-2 border-white' sx={{ width: 70, height: 70 }} src="https://avatars.githubusercontent.com/u/75667121?s=400&u=2147ca1b438f9bff4717d0c9e058ba77e07f5a6a&v=4"/>
            <h2 className='text-md font-semibold text-gray-700'>Abdul Basit Iqbal</h2>
        ...
        <div className="p-2 border-b-0 border-[1px] border-gray-300 bg-white">
            ...
            <div className="mt-2 mb-1 flex justify-between">
                <p className='text-gray-400 text-xs font-semibold'>Post impressions</p>
        ...
        <div className="p-2 border-b-0 border-[1px] border-gray-300 bg-white">
            <div className="mt-2 mb-1 flex items-start">
                <p className='text-gray-400 text-start text-xs'>When the going gets tough, the tough get going</p>
            </div>
        </div>
        ...
        <div className="p-2 mb-2 border-[1px] border-gray-300 bg-white rounded-b-lg hover:bg-gray-100 cursor-pointer">
            <div className="mt-2 mb-1 flex items-start">
                ...
                <p className='text-gray-800 font-semibold text-start text-xs pl-2'>+92 3319868432</p>
            </div>
        </div>
